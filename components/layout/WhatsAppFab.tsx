...
export function WhatsAppFab() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-30 flex h-14 w-14 items-center justify-center rounded-full bg-crimson text-midnight shadow-lg shadow-midnight/50 transition-colors duration-300 ease-map hover:bg-cool-white sm:bottom-8 sm:right-8"
    >
